<?php
$title="Endless CVS Receipt";
include "../login/misc/pagehead.php";
?>
<link href="https://fonts.googleapis.com/css?family=Libre+Barcode+128|VT323|Roboto" rel="stylesheet"> 
<style>
    * {
        margin: 0;
...
<div id="showScroll" class="container">
	<div class="receipt">
		...
		<div class="transactionDetails">
			...
			<div class="detail">RED BULL ENERGY 8.4Z</div>
			<div class="detail">2.39</div>
		</div>
        <div class="transactionDetails">
			<div class="detail">1</div>
			<div class="detail">RED BULL ENERGY 8.4Z</div>
